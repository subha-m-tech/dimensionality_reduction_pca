...
def pca_classification(acclog,accsvml,accsvmnl,accknn,accnav,accdes,accrf,n): 
    """This method returns dataframe with accuracy of different alogorithms"""
    dataframe=pd.DataFrame(index=['pca: '+str(n)],columns=['Logistic','SVMl','SVMnl','KNN','Navie','Decision','Random'])
